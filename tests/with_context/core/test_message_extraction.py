...
def test_task_id_extraction():
    ...
    assert extract_task_id(message) == "456-XYZ-789", (
    ...
    assert extract_task_id(message) is None, (
    ...
    assert extract_task_id(message) == "FIRST123", (
    ...
    assert extract_task_id(message) == "user_123.456.789", (

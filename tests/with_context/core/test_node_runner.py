...
class TestNodeRunner:
    ...
    def test_debug_logging(self, node_runner, mock_logger):
        ...
        mock_logger.debug.assert_called_once_with(
            "Task test_node: test debug message for task_id: test_123", stacklevel=2
        )
    ...
    def test_info_logging(self, node_runner, mock_logger):
        ...
        mock_logger.info.assert_called_with(
            "Task test_node: test info message task_id: test_123", stacklevel=2
        )
    ...
    def test_warning_logging(self, node_runner, mock_logger):
        ...
        mock_logger.warning.assert_called_once_with(
            "Task test_node: test warning message task_id: test_123", stacklevel=2
        )
    ...
    def test_error_logging(self, node_runner, mock_logger):
        ...
        mock_logger.error.assert_called_once_with(
            "Task test_node: test error message task_id: test_123", stacklevel=2
        )
    ...
    def test_fail_method(self, node_runner, mock_logger):
        ...
        mock_logger.exception.assert_called_with(
            "Task test_node: Something went wrong task_id: test_123", stacklevel=2
        )

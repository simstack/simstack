...
@pytest.mark.asyncio
async def test_node_from_database_basic(initialized_context):
...
@pytest.mark.asyncio
async def test_node_from_database_signature_fix(initialized_context):
    ...
    # We NEED a NodeModel in the DB for _find_node_model to succeed when cache is empty
...
@pytest.mark.asyncio
async def test_node_from_database_duplicate(initialized_context):

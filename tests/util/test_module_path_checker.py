...
class TestIsModuleSubpathOfPath:
    ...
    def setup_method(self):
        ...
        os.makedirs(os.path.join(self.project_root, "src", "simstack", "core"), exist_ok=True)
        os.makedirs(os.path.join(self.project_root, "src", "simstack", "util"), exist_ok=True)
    ...
    def test_find_project_root_called(self):
        ...
        with patch('simstack.util.module_path_checker.find_project_root') as mock_find_root:
            mock_find_root.return_value = self.project_root

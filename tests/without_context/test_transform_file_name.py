...
def test_transform_file_name_resolves_home_directory(monkeypatch, environment_variables: Path):
    """Test that $HOME in the supplied path is replaced with the user's home directory."""
    temp_path = environment_variables
...
def test_transform_file_name_resolves_temp_directory(monkeypatch, environment_variables: Path):
...
def test_transform_file_name_resolves_project_directory(monkeypatch, environment_variables: Path):
...
def test_transform_file_name_raises_error_for_nonexistent_path(monkeypatch, environment_variables: Path):
...
def test_path_with_var(environment_variables: Path):
    temp_path = environment_variables

...
def test_transform_file_name_resolves_home_directory(
    monkeypatch, prepared_directory_path: Path
):
...
def test_transform_file_name_resolves_temp_directory(
    monkeypatch, prepared_directory_path: Path
):
...
def test_transform_file_name_resolves_project_directory(
    monkeypatch, prepared_directory_path: Path
):
...
def test_transform_file_name_raises_error_for_nonexistent_path(
    monkeypatch, prepared_directory_path: Path
):

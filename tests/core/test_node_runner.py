...
class TestNodeRunner:
    ...
    def test_init_custom_values(self, mock_logger):
        ...
        runner = NodeRunner(name="custom_node", logger=mock_logger, task_id="custom_123")
    ...
    def test_subprocess_success(self, mock_file_stack, mock_file, mock_subprocess, node_runner):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch.object(FileStack, 'from_local_file')
    def test_subprocess_failure(self, mock_file_stack, mock_file, mock_subprocess, node_runner):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch.object(FileStack, 'from_local_file')
    def test_subprocess_default_name(self, mock_file_stack, mock_file, mock_subprocess, node_runner):
    ...
    def test_succeed_method(self, node_runner, mock_logger):
        ...
        expected_calls = [
            ...
            call("Task test_node: succeeded Task completed successfully task_id: test_123")
        ]
...
class TestNodeRunnerIntegration:
    ...
    def test_full_workflow_success(self, mock_logger, tmp_path):
        ...
        try:
            runner = NodeRunner(name="integration_test", logger=mock_logger, task_id="int_123")
    ...
    def test_full_workflow_failure(self, mock_logger, tmp_path):
        ...
        try:
            runner = NodeRunner(name="integration_fail", logger=mock_logger, task_id="fail_123")

...
def test_complex_network():
    ...
    routes = [
        ...
        {'source': 'int-nano', 'target': 'horeka', 'host': 'int-nano'},  # Direct connection
    ]
...
def test_route_data_preservation():
    ...
    routes = [
        {'source': 'A', 'target': 'B', 'host': 'A', 'extra_field': 'value1', 'cost': 10},
        {'source': 'B', 'target': 'C', 'host': 'B', 'extra_field': 'value2', 'cost': 20},
    ]

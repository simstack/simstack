...
class DirectoryPath:
    ...
    def iterate_files(self) -> Iterator[Path]:
        ...
        for root, dirs, files in os.walk(self.root_path):
            ...
            for file in files:
                ...
                if not self._is_excluded(file_path) and self._matches_extensions(file_path):
                    yield file_path
    ...
    def __str__(self) -> str:
        return f"DirectoryPath(root='{self.root_path}', excluded={self.excluded_patterns})"
    
    def __repr__(self) -> str:
        return (f"DirectoryPath(root_path='{self.root_path}', "
                f"excluded_patterns={self.excluded_patterns}, "
                f"file_extensions={self.file_extensions})")


# Example usage and utility functions
def find_python_files_with_exclusions(root_path: str, excluded_patterns: List[str] = None) -> List[Path]:
    """
    ...
    """
    excluded_patterns = excluded_patterns or ['__pycache__', '*.pyc', '.git', '.venv', 'venv']

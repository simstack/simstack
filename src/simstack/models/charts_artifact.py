...
class AGChartSeriesBase(EmbeddedModel):
    ...
    visible: Optional[bool] = Field(default=True, description="Whether series is visible")
...
class AGLineSeriesConfig(AGChartSeriesBase):
    ...
    lineDash: Optional[List[float]] = Field(default=None, description="Line dash pattern")
    marker: Optional[Dict[str, Any]] = Field(default=None, description="Marker configuration")
    tooltip: Optional[Dict[str, Any]] = Field(default=None, description="Tooltip configuration")
...
class AGPieSeriesConfig(EmbeddedModel):
    ...
    radiusKey: Optional[str] = Field(default=None, description="Key for pie slice radius")
    labelKey: Optional[str] = Field(default=None, description="Key for pie slice labels")
    visible: Optional[bool] = Field(default=True, description="Whether series is visible")
    showInLegend: Optional[bool] = Field(default=True, description="Show in legend")
    title: Optional[str] = Field(default=None, description="Series title")
    tooltip: Optional[Dict[str, Any]] = Field(default=None, description="Tooltip configuration")
...
class AGDonutSeriesConfig(EmbeddedModel):
    ...
    radiusKey: Optional[str] = Field(default=None, description="Key for donut slice radius")
    labelKey: Optional[str] = Field(default=None, description="Key for donut slice labels")
    innerRadiusRatio: Optional[float] = Field(default=0.6, description="Inner radius ratio")
    visible: Optional[bool] = Field(default=True, description="Whether series is visible")
    showInLegend: Optional[bool] = Field(default=True, description="Show in legend")
    title: Optional[str] = Field(default=None, description="Series title")
    tooltip: Optional[Dict[str, Any]] = Field(default=None, description="Tooltip configuration")
...
class AGChartAxisConfig(EmbeddedModel):
    ...
    type: Literal["category", "number", "time", "log"] = Field(..., description="Axis type")
    position: Literal["top", "right", "bottom", "left"] = Field(..., description="Axis position")
    ...
    tick: Optional[Dict[str, Any]] = Field(default=None, description="Tick configuration")
    label: Optional[Dict[str, Any]] = Field(default=None, description="Label configuration")
    gridStyle: Optional[List[Dict[str, Any]]] = Field(default=None, description="Grid line style")
...
class AGChartLegendConfig(EmbeddedModel):
    ...
    position: Literal["top", "right", "bottom", "left"] = Field(default="right", description="Legend position")
    spacing: float = Field(default=20, description="Legend spacing")
    item: Dict[str, Any] = Field(default_factory=dict, description="Legend item configuration")
...
class ChartArtifactModel(Model):
    ...
    series: List[AGChartSeries] = Field(default_factory=list, description="Chart series configurations")

    # Axes configuration
    axes: List[AGChartAxisConfig] = Field(default_factory=list, description="Chart axes configurations")

    # # Legend configuration
    legend: AGChartLegendConfig = Field(default=AGChartLegendConfig(), description="Legend configuration")
    #
    ...
    background: Optional[Dict[str, Any]] = Field(default=None, description="Background configuration")

    # Animation
    animation: Optional[Dict[str, Any]] = Field(default=None, description="Animation configuration")

    # Tooltip
    tooltip: Optional[Dict[str, Any]] = Field(default=None, description="Global tooltip configuration")

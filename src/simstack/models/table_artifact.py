...
class AGGridColumnDef(EmbeddedModel):
    ...
    minWidth: Optional[int] = Field(default=None, description="Minimum column width in pixels")
    maxWidth: Optional[int] = Field(default=None, description="Maximum column width in pixels")
    flex: Optional[int] = Field(default=None, description="Flex sizing for responsive columns")
    ...
    sortable: Optional[bool] = Field(default=None, description="Whether the column can be sorted")
    resizable: Optional[bool] = Field(default=None, description="Whether the column can be resized")
    editable: Optional[bool] = Field(default=None, description="Whether cells in this column are editable")
...
class TableArtifactModel(Model):
    ...
    columns_defs: List[AGGridColumnDef] = Field(default_factory=list, description="AG-Grid column definitions")
    row_data: List[Dict[str, Any]] = Field(default_factory=list, description="List of row objects")

    # Master-Detail configuration
    master_detail: Optional[bool] = Field(default=False, description="Enable master-detail rows")
    detail_cell_renderer: Optional[str] = Field(default=None, description="Detail panel cell renderer")
    detail_cell_renderer_params: Optional[Dict[str, Any]] = Field(default=None, description="Parameters for detail renderer")
